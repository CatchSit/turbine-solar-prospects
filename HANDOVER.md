...
**Already done:**
- Repo created and pushed to `main` (https://github.com/CatchSit/turbine-solar-prospects); Supabase project `turbine-solar-prospects` created, migrations 001–012 applied.
...
- Company sector & maturity classification built (migration 012, `company-lookup` extended with `accounts_type`, `scripts/classify-companies.mjs`, sidebar filters, popup tags/badges) — **code shipped and deployed 2026-08-20, but the actual classification run hasn't started** (Section 4, Step 7) — every prospect currently shows no sector/maturity data.
